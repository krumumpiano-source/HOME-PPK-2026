...
function renderPPKNav(containerId, activePage) {
  ...
  var residentLinks =
    ...
    navLink('electrical-info', '\u26a1',     '\u0e04\u0e27\u0e32\u0e21\u0e23\u0e39\u0e49\u0e44\u0e1f\u0e1f\u0e49\u0e32',    '\u0e2a\u0e32\u0e22\u0e44\u0e1f \u0e21\u0e34\u0e40\u0e15\u0e2d\u0e23\u0e4c \u0e04\u0e33\u0e19\u0e27\u0e13\u0e01\u0e33\u0e25\u0e31\u0e07\u0e44\u0e1f') +
  ...
  if (hasAnyPerm) {
    ...
    if (isAdmin || _hasPerm('water') || _hasPerm('water_reader')) adminLinks += navLink('record-water', '\ud83d\udca7', '\u0e1a\u0e31\u0e19\u0e17\u0e36\u0e01\u0e04\u0e48\u0e32\u0e19\u0e49\u0e33', '\u0e1a\u0e31\u0e19\u0e17\u0e36\u0e01\u0e21\u0e34\u0e40\u0e15\u0e2d\u0e23\u0e4c\u0e19\u0e49\u0e33\u0e23\u0e32\u0e22\u0e40\u0e14\u0e37\u0e2d\u0e19');
    ...
    if (isAdmin) adminLinks += navLink('check-report', '\ud83d\udcdd', '\u0e15\u0e23\u0e27\u0e08\u0e23\u0e32\u0e22\u0e07\u0e32\u0e19', '\u0e25\u0e07\u0e19\u0e32\u0e21\u0e2d\u0e19\u0e38\u0e21\u0e31\u0e15\u0e34\u0e23\u0e32\u0e22\u0e07\u0e32\u0e19');
    if (isAdmin) adminLinks += navLink('view-as-user', '\ud83d\udc41\ufe0f', '\u0e14\u0e39\u0e21\u0e38\u0e21\u0e21\u0e2d\u0e07\u0e1c\u0e39\u0e49\u0e43\u0e0a\u0e49', '\u0e14\u0e39\u0e02\u0e49\u0e2d\u0e21\u0e39\u0e25\u0e17\u0e38\u0e01\u0e1a\u0e49\u0e32\u0e19\u0e43\u0e19\u0e21\u0e38\u0e21\u0e21\u0e2d\u0e07\u0e04\u0e19\u0e1e\u0e31\u0e01');
    if (isAdmin) adminLinks += navLink('admin-settings', '\ud83d\udd27', '\u0e15\u0e31\u0e49\u0e07\u0e04\u0e48\u0e32\u0e41\u0e2d\u0e14\u0e21\u0e34\u0e19', '\u0e15\u0e31\u0e49\u0e07\u0e04\u0e48\u0e32\u0e23\u0e30\u0e1a\u0e1a');
    if (isAdmin) adminLinks += navLink('admin-report', '\ud83d\udcca', '\u0e23\u0e32\u0e22\u0e07\u0e32\u0e19\u0e1a\u0e23\u0e34\u0e2b\u0e32\u0e23', '\u0e2a\u0e23\u0e38\u0e1b\u0e1c\u0e25\u0e07\u0e32\u0e19\u0e40\u0e2a\u0e19\u0e2d\u0e1c\u0e39\u0e49\u0e1a\u0e23\u0e34\u0e2b\u0e32\u0e23');
    if (isAdmin) adminLinks += navLink('activity-log', '\ud83d\udcca', 'Activity Log', '\u0e14\u0e39\u0e01\u0e34\u0e08\u0e01\u0e23\u0e23\u0e21\u0e1c\u0e39\u0e49\u0e43\u0e0a\u0e49');
    if (isAdmin) adminLinks += navLink('warnings', '\u26a0\ufe0f', '\u0e15\u0e31\u0e01\u0e40\u0e15\u0e37\u0e2d\u0e19', '\u0e2b\u0e19\u0e31\u0e07\u0e2a\u0e37\u0e2d\u0e15\u0e31\u0e01\u0e40\u0e15\u0e37\u0e2d\u0e19\u0e1c\u0e39\u0e49\u0e1e\u0e31\u0e01\u0e2d\u0e32\u0e28\u0e31\u0e22');
    if (isAdmin) adminLinks += navLink('meetings', '📝', 'บันทึกการประชุม', 'รายงานการประชุมคณะกรรมการ');
    if (isAdmin) adminLinks += navLink('admin-publish', '📢', 'จัดการเผยแพร่', 'ดูและเผยแพร่รายงานสู่สาธารณะ');
    if (isAdmin) adminLinks += navLink('public-reports', '🌐', 'หน้ารายงานสาธารณะ', 'หน้าทดสอบรายงานส่วนกลาง');
    if (isAdmin) adminLinks += navLink('mou', '📜', 'สัญญา MOU', 'สัญญาเช่าบ้านพักครู');
  }
